...
public class SClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("please use connect ip address:port as name  to connect !");
    ...
    private static void sendToServer(String sendToServer) {
        try {
            ...
            if (matcher2.find()) {
                ...
                String httpsURL1 = "https://127.0.0.1:8890/send?message=" + message
                        + "&receiver=" + receiver
                        + "&sender=" + sender;
                URL myUrl1 = new URL(httpsURL1);
                HttpsURLConnection conn1 = (HttpsURLConnection) myUrl1.openConnection();
    ...
    private static void getList() {
        try {
            ...
            String httpsURL1 = "https://127.0.0.1:8890/list?name=" + name;
            URL myUrl1 = new URL(httpsURL1);
            HttpsURLConnection conn1 = (HttpsURLConnection) myUrl1.openConnection();
    ...
    private static void checkInbox() {
        try {
            ...
            String httpsURL1 = "https://127.0.0.1:8890/inbox?name=" + name;
            URL myUrl1 = new URL(httpsURL1);
            HttpsURLConnection conn1 = (HttpsURLConnection) myUrl1.openConnection();
